      ...
      <table class="table">
        ...
        if (mysqli_num_rows($result) > 0) {
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                echo "<td style='padding: 35px;'>".$row['name']."</td>";
                echo "<td style='padding: 35px;'>".$row['designation']."</td>";
                echo "<td style='padding: 35px;'>".$row['email']."</td>";
                echo "<td style='padding: 35px;'>".$row['mobile']."</td>";
                echo "<td style='padding: 35px;'>".$row['experience']."</td>";
                echo "</tr>";
            }
            echo "</table>";
        } else {
