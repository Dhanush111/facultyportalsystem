...
$sql = "SELECT * FROM faculty_issues";
...
if (mysqli_num_rows($result) > 0) {
  ...
  echo '<div class="card">';
  echo '<h5 class="card-header">Faculty Issues</h5>';
  echo '<div class="card-body">';
  echo '<table class="table">';
  echo '<thead>';
  echo '<tr>';
  echo '<th scope="col">Faculty Name</th>';
  echo '<th scope="col">Issue type</th>';
  echo '<th scope="col">Issue Description</th>';
  echo '<th scope="col">Date Occurred</th>';
  echo '</tr>';
  echo '</thead>';
  echo '<tbody>';
