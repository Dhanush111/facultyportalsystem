...
if ($result->num_rows > 0) {
  ...
  echo '<div class="card">';
  echo '<h5 class="card-header">Book Chapters</h5>';
  ...
  echo '<th scope="col">Chapter Title</th>';
  echo '<th scope="col">Chapter Authors</th>';
  echo '<th scope="col">Publication Date</th>';
  echo '<th scope="col">Chapter Pages</th>';
  echo '</tr>';
  echo '</thead>';
  echo '<tbody>';
  while ($row = $result->fetch_assoc()) {
    ...
    echo '<td>' . $row['chapter_authors'] . '</td>';
    echo '<td>' . $row['chapter_publication_date'] . '</td>';
    echo '<td>' . $row['chapter_pages'] . '</td>';
    echo '</tr>';
  }
  echo '</tbody>';
  echo '</table>';
