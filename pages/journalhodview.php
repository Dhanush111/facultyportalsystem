...
// Prepare and execute SQL query to retrieve all rows from the journals table
...
if ($result->num_rows > 0) {
    ...
    echo '<div class="card">';
    echo '<h5 class="card-header">Journals</h5>';
    echo '<div class="card-body">';
    echo '<table class="table">';
    echo '<thead>';
    echo '<tr>';
    echo '<th scope="col">Journal Title</th>';
    echo '<th scope="col">Journal Authors</th>';
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        echo '<td>' . $row['journal_authors'] . '</td>';
        echo '<td>' . $row['journal_publication_date'] . '</td>';
        echo '<td>' . $row['journal_publisher'] . '</td>';
        echo '</tr>';
    }
    echo '</tbody>';
    echo '</table>';
