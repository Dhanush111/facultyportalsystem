...
if (mysqli_num_rows($result) > 0) {
  ...
  echo '<div class="card">';
  echo '<h5 class="card-header">Monthly Reports</h5>';
  echo '<div class="card-body">';
  echo '<table class="table">';
  echo '<thead>';
  echo '<tr>';
  echo '<th scope="col">Faculty Name</th>';
  echo '<th scope="col">Report Link</th>';
  echo '<th scope="col">Month</th>';
  echo '<th scope="col">Feedback</th>';
  echo '<th scope="col">Improvements</th>';
  echo '</tr>';
  echo '</thead>';
  echo '<tbody>';
  while ($row = mysqli_fetch_assoc($result)) {
    ...
    echo '<td><a href="' . $row['report_link'] . '">' . $row['report_link'] . '</a></td>';
