...
if ($result->num_rows > 0) {
    ...
    echo '<div class="card">';
    echo '<h5 class="card-header">Conferences Attended</h5>';
    ...
    while ($row = $result->fetch_assoc()) {
        echo '<tr>';
        echo '<td>' . $row['conference_title'] . '</td>';
        echo '<td>' . $row['conference_authors'] . '</td>';
        echo '<td>' . $row['conference_publication_date'] . '</td>';
        echo '<td>' . $row['conference_location'] . '</td>';
        echo '</tr>';
    }
    echo '</tbody>';
    echo '</table>';
