...
// Query the database to retrieve the certificate data
            ...
            <tbody>
              <?php foreach ($certificates as $key => $certificate): ?>
                <tr>
                  ...
                  <td><?php echo $certificate['faculty_name'] ?></td>
                  <td><?php echo $certificate['certificate_title'] ?></td>
